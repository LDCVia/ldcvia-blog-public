...
tags: ["ldc via", ibmconnect, conferences]
---
...
[Mark Myers](https://stickfight.co.uk) is presenting a session with [Gabriella Davis](https://turtleblog.info/) about SSL and SHA2 Certificates:

#### The SSL Problem and How to Deploy SHA2 Certificates

_Monday 11:30-12:30 | Lake Eola A_
...
[Matt White](https://mattwhite.me) will be presenting a quickfire session about node.js:

#### node.js for Domino Developers

_Tuesday 10:30-11:00 | Solution EXPO Theater_
...
And of course we’re keen to talk to people about [LDC Via](https://ldcvia.com) , so if you’d like to arrange a meeting ~~you can do that here.~~
