...
2016 has been an extremely busy year for LDC Via: various technical challenges as one would expect. New products to launch — more on [KEEP.WORKS](https://keep.works) in a separate post — together with meetings to chair, proposals to write, and partnerships to forge!

It is of the latter we wish to speak today. Some months ago, we opened discussions with our good friend [Andrew Magerman](https://www.magerman.com/en/Homepage.html), and these quickly bore fruit: [Swiss LDC Via](https://ch.ldcvia.com).
