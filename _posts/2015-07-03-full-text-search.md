...
Full search functionality will now be available in both the standard templates we offer and the [LDC Via API](https://api.ldcvia.com/#search-in-a-collection).
